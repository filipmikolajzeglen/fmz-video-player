...
class VolumeController
{
   ...
   {
      VideoPlayerIcons.setControlSVG(labelVolume, labelVolumeSVG, FMZVideoPlayerConfiguration.Icons.VOLUME1());
   }

   private void setLabelVolume2SVG()
   {
      VideoPlayerIcons.setControlSVG(labelVolume, labelVolumeSVG, FMZVideoPlayerConfiguration.Icons.VOLUME2());
   }

   private void setLabelVolumeMuteSVG()
   {
      VideoPlayerIcons.setControlSVG(labelVolume, labelVolumeSVG, FMZVideoPlayerConfiguration.Icons.MUTE());
   }
